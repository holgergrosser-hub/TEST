...
@click.option(
    "--description",
    default="customer service demo using Agent Development Kit",
...
@click.option(
    "--entrypoint-module",
    default="customer_service.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="customer_service/app_utils/.requirements.txt",
...
def deploy_agent_engine_app(
    ...
    labels_dict["vertex-agent-sample-id"] = "customer-service"
